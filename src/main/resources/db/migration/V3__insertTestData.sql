...
values('Bradley Alexander Abbe','Baltimore','23-35-2324','2015-05-16','MALE'),
      ('Martin Quinn Abbett','Boston','23-45-4324','2015-05-16','MALE'),
      ('Max Mendoza Alan','Brooklyn','23-42-2324','2015-05-16','MALE'),
      ('Stephen Allen Alden','Charlotte','23-35-1324','2015-05-16','MALE'),
      ('Dominic Clarke Beaner','Central Jersey','13-45-2324','2015-05-16','MALE'),
      ('Theobold Elliott Bear','Philadelphia','23-45-2324','2015-05-16','MALE'),
      ('Davy Mills Bearfield','Pittsburgh','22-45-2324','2015-05-16','MALE'),
      ('Dominic Bowman Beatley','Queens','23-25-2324','2015-05-16','MALE'),
      ('Zachary Mason Beaver','South Florida','23-42-2321','2015-05-16','MALE'),
      ('Keith Oliver Chace','South Jersey','23-45-1324','2015-05-16','MALE'),
      ('Manfred Webb Chadburn','Austin','23-45-2224','2015-05-16','MALE'),
      ('Milton Daniels Chaddick','Chicago','23-45-2314','2015-05-16','MALE'),
      ('Robin Greenwood Chadwell','Dallas','23-45-2322','2015-05-16','MALE'),
      ('Justin Rodriquez Chaffey','Denver','23-45-2354','2015-05-16','MALE'),
      ('Ford Simonds Chalkley','Detroit','23-45-2524','2015-05-16','MALE'),
      ('Ferris Eland Chamberlain','Houston','23-45-4124','2015-05-16','MALE'),
      ('Rocky Black Dabler','Santa Barbara','23-46-2324','2015-05-16','MALE');
...
values('Russ Abbot','Baltimore','73-35-2324','2015-05-16','MALE','first'),
      ('Michael Aldridge','Boston','723-45-4324','2015-05-16','MALE','first'),
      ('Chesney Allen','Brooklyn','723-42-2324','2015-05-16','MALE','first'),
      ('Arthur Askey','Charlotte','723-35-1324','2015-05-16','MALE','first'),
      ('Robin Askwith','Central Jersey','713-45-2324','2015-05-16','MALE','second'),
      ('Rowan Atkinson','Philadelphia','723-45-2324','2015-05-16','MALE','second'),
      ('Richard Ayoade','Pittsburgh','722-45-2324','2015-05-16','MALE','second'),
      ('Trevor Bannister','Queens','723-25-2324','2015-05-16','MALE','second'),
      ('Ronnie Barker','South Florida','723-42-2321','2015-05-16','MALE','second'),
      ('Sacha Baron Cohen','South Jersey','723-45-1324','2015-05-16','MALE','second'),
      ('Chris Barrie','Austin','723-45-2224','2015-05-16','MALE','third'),
      ('Alfie Bass','Chicago','723-45-2314','2015-05-16','MALE','third'),
      ('Colin Bean','Dallas','723-45-2322','2015-05-16','MALE','third'),
      ('James Beck','Denver','723-45-2354','2015-05-16','MALE','third'),
      ('Richard Beckinsale','Detroit','723-45-2524','2015-05-16','MALE','third'),
      ('Harold Bennett','Houston','723-45-4124','2015-05-16','MALE','third'),
      ('Michael Bentine','Santa Barbara','723-46-2324','2015-05-16','MALE','third');
